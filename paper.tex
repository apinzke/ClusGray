...
the luminostity from the stars using
\begin{eqnarray}
...
account for different cluster masses in our analisys we adopt a simple
...
$L_\dust=10^{44.8}\left(\frac{N_{200}}{10}\right)^{0.8}$. We pic a high
