...
\begin{figure}
  ...
  \caption{\it Luminosity to mass scaling relations. We show the
    luminosity from; CRp induced emission (red solid), a leptophilic
    model that IC upscatter CMB photons (green dash-dotted), mass
    dependence of SD cooling have been neglected, actually a factor
    few difference for groups. factor 2 for Fornax, and small
    difference for large clusters}
