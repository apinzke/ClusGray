...
the CR transport equation (neglecting convection and re-acceleration
effects):
\begin{eqnarray}
...
electrons and positrons: (1) IC losses on CMB photons with the
...
\caption{\it Comparing the flux from different inverse Compton
  ...
  orange solid line.  The red solid line show the CR induced
