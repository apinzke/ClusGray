...
annihilating neutralinos, internal bremsstrahlung, and inverse Compton
emission from the cosmic microwave background as well as from a
realistic spatial and spectral distribution of dust and stellar light.
After the galactic center, which hosts many astrophysical sources,
galaxy clusters are the best known target class to detect DM
annihilation. We predict Virgo and Fornax to be the brightest DM
sources and find a particularly low CR induced background for
Fornax. For a given minimum substructure mass as given by the DM
free-streaming scale, one needs the largest DM halo mass to maximize
the substructure boost over the smoothly distributed annihilation
flux: for galaxy clusters as the largest collapsed objects, we find a
...
flat. This makes it very challenging to detect this flux with imaging
air Cherenkov telescopes since their sensitivity drops linearly with
radius and they typically encounter have $5-10$ linear resolution
elements across a cluster; the gamma-ray satellite Fermi is better
suited. Assuming cold dark matter with a substructure mass
distribution down to an Earth mass and using Fermi upper limits, we
rule out the leptophilic models in their present form in 14 clusters,
and limit the boost from Sommerfeld enhancement in Fornax to be less
than 2 which corresponds to a value in the Milky Way of less than
5. Alternatively, if the Sommerfeld enhancement factor is realized in
Nature, this would imply a limiting substructure mass in Fornax of
$\mlim > 10^2\,\msun$ corresponding to a Milky Way value of $\mlim >
5\times 10^3\,\msun$ which would be a hint for an unknown form of warm
dark matter. We find that Fermi three-year data will be able to
constrain the smallest mass of substructures for supersymmetric
benchmark models or alternatively constrain their cross sections for a
given substructure boost. Although the Perseus and Ophiuchus clusters
are expected to have the largest CR induced flux according to our
semi-analytic model that is derived from cosmological hydrodynamical
cluster simulations, their central active galactic nucleus as well as
the Galactic foreground makes it hard to detect this flux in the Fermi
band. The next to best targets to detect the CR flux are Virgo, Coma,
and Norma -- the Fermi upper limits are closing in on our predictions
and will soon start to constrain the underlying CR physics such as
