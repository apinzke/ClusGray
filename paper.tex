...
targets for indirect DM searches. \C{Note, however, that the angular
  ...
  $(2.8,\,1.6,\,5.3)$, respectively. Similarly, it is interesting to
  compare the radius that contain 68\% of the flux to the assumed
  extension, $r_\sigma/\sigma$, which is given by $(1.7,\,1.0,\,3.3)$ for
...
\C{A quantity that is of great scientific interest is the CR pressure
  ...
  mass scaling of the relative CR pressure from,
\begin{equation}
 X_\CR = \frac{P_\CR}{P_\rmn{th}} \propto \frac{\rho_\rmn{gas}\,
   \tilde{C}}{k_\B T} \propto M^{-0.06}\,,
\end{equation}
which is roughly a constant, i.e. almost independent on mass. Since
the CRs that build up the bulk of the CR pressure also give rise to
gamma-ray emission through the production of decaying pions, we can
use gamma-ray upper limits from Fermi-LAT to constrain $X_\CR$. These
upper limits are 95 percent confidence limits and assume a spectral
index of 2. EXPAND DISCUSSION, ADD VOLUME WEIGHT, HOW TO GO FROM
GAMMA->XCR.}

\C{In Fig.~\ref{fig:XCR} we show the volume weighted relative CR
  pressure for 32 clusters, for which Fermi-LAT gamma-ray upper limits
  are derived. We find that the most constraining clusters are the
  Norma and Coma clusters of $X_\CR < 0.07$.} 
