...
\begin{minipage}{2.0\columnwidth}
  ...
  \caption{\it Fermi-LAT flux upper limits are contrasted to the predictions by
    ...
    (note that both models assume the maximally allowed acceleration efficiency
    for strong shocks and most likely will have to be corrected down, see
    \cite{2010MNRAS.409..449P} for details). Note that there is currently no
    tension between our predictions and upper limits from Fermi, although Virgo,
    Norma, and Coma are coming close and will enforce constraints on the
    hadronic models in the coming years.}
 \label{fig15}
\end{minipage}
\end{figure*}
...
\end{minipage}
\end{figure*}
 best clusters, stacking unlikely to improve
